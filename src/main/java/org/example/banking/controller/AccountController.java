...
import org.example.banking.dto.account.request.client.UpdateClientRequest;
...
public class AccountController {
    ...
    public ResponseEntity<AccountResponse> update(@PathVariable Long id,
                                                  @Valid @RequestBody org.example.banking.dto.account.request.client.UpdateClientRequest req) {
